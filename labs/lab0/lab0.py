...
Github Username:
"""
name = "Vincent Wu" # TODO: your name
SID = 917238964 # TODO: your student id
git_username = "vincentwu2" # TODO: your github username
print(name)
print(SID)
print(git_username)
print('\n')
...
# TODO: your code here
print("\"Alice\" appeared", myString.count("Alice"), "times.")
...
for i in range(len(numbers)):
    if i == 0:
        results3.append(numbers[i])
    else:
        results3.append(numbers[i-1]+numbers[i])
